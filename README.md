...
Docker provides a very good mechanism to persist data (such as database content). This mechanim is driven by [Volumes](https://docs.docker.com/engine/tutorials/dockervolumes/)
